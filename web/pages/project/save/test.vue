<template>
    ...
    <div class="form-container">
        <label>ชื่อ: <input type="text" v-model="name" placeholder="name"></label><br>

        <label>เวลาในการทำงาน (วินาที): <input type="number" v-model.number="runtime" @input="checkRuntime"
        ...
        <label>pH ดิน: <input type="number" placeholder=" pH "></label><br>

        <label>ตั้งค่าเวลาในการทำงาน:</label><br>    
        <div v-for="(time, index) in times" :key="index" class="time-input">
            <label>เวลา {{ index + 1 }}: <input type="time" v-model="times[index]"></label>
